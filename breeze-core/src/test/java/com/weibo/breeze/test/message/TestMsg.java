    ...
    public Message readFromBuf(BreezeBuffer buffer) throws BreezeException {
        BreezeReader.readMessage(buffer, (int index) -> {
            switch (index) {
                ...
                case 3:
                    myMap = new HashMap<>();
                    BreezeReader.readMap(buffer, myMap, genericTypes.get("myMap" + Breeze.KEY_TYPE_SUFFIX), genericTypes.get("myMap" + Breeze.VALUE_TYPE_SUFFIX));
                    break;
                case 4:
                ...
                case 7:
                    ...
                    BreezeReader.readCollection(buffer, enumArray, genericTypes.get("enumArray" + Breeze.VALUE_TYPE_SUFFIX));
                    break;
