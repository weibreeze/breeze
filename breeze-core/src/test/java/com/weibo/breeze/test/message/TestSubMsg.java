    ...
    public Message readFromBuf(BreezeBuffer buffer) throws BreezeException {
        BreezeReader.readMessage(buffer, (int index) -> {
            switch (index) {
                ...
                case 8:
                    myMap1 = new HashMap<>();
                    BreezeReader.readMap(buffer, myMap1, genericTypes.get("myMap1" + Breeze.KEY_TYPE_SUFFIX), genericTypes.get("myMap1" + Breeze.VALUE_TYPE_SUFFIX));
                    break;
                case 9:
                    myMap2 = new HashMap<>();
                    BreezeReader.readMap(buffer, myMap2, genericTypes.get("myMap2" + Breeze.KEY_TYPE_SUFFIX), genericTypes.get("myMap2" + Breeze.VALUE_TYPE_SUFFIX));
                    break;
                case 10:
                    myArray = new ArrayList<>();
                    BreezeReader.readCollection(buffer, myArray, genericTypes.get("myArray" + Breeze.VALUE_TYPE_SUFFIX));
                    break;
                case 11:
